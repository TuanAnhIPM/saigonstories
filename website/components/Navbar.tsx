      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-cream/95 backdrop-blur-sm border-b border-sand/60">
        <nav className="relative h-18 flex items-center px-6">
          ...
          <div className="ml-auto flex items-center gap-2">
            <Link
              href="/contact"
              className="hidden md:flex items-center gap-2 text-xs text-muted hover:text-terracotta transition-colors"
            >
              ...
              <span className="font-semibold text-espresso hover:text-terracotta transition-colors">Contact Us</span>
            </Link>
            <Link
              href="/contact"
