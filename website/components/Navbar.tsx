...
const tourDropdown = [
  ...
  { href: '/tours/premium-seafood-rooftop',   label: 'The Ultimate Saigon Food by Bike' },
]
        ...
        <nav className="relative h-18 flex items-center px-6">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            >
              ...
              <span>+84 363 252 764</span>
            </a>

            {/* Divider — desktop */}
            <span className="hidden md:block w-px h-5 bg-sand" />

            {/* Book Tour button — desktop */}
            <Link
              href="/contact"
              className="hidden md:flex bg-terracotta text-cream text-xs font-semibold px-4 py-2 rounded-full hover:bg-terracotta-dark transition-colors whitespace-nowrap"
            >
              Book Tour
            </Link>

            {/* Mobile: Book Tour only */}
            <Link
              href="/contact"
              className="md:hidden bg-terracotta text-cream text-sm font-medium px-4 py-2 rounded-full hover:bg-terracotta-dark transition-colors whitespace-nowrap"
            >
              Book Tour
            </Link>
          </div>
